...
namespace Services
{
    public class TutorialBootstrap : MonoBehaviour, IServiceBootstrap
    {
        ...
        public void Bootstrap()
        {
            ...
            ServiceLocator.Instance.Register<ILevelManager>(FindFirstObjectByType<tutorialLevelManager>());
